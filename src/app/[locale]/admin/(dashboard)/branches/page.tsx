...
// Defined outside so identity is stable; inline component definitions
// inside the page would lose input focus on every setState call.
              ...
              {isEditing && draft ? (
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <button onClick={() => toggleOpen(b)} style={{ ...ghostBtn, fontSize: 12, padding: '6px 14px' }}>
